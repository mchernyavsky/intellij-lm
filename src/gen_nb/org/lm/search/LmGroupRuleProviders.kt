...
import org.nbkit.common.psi.ext.parentOfType

class LmModuleGroupingRuleProvider : FileStructureGroupRuleProvider {
    override fun getUsageGroupingRule(project: Project): UsageGroupingRule? = createGroupingRule<LmModule>()
}

class LmVariableGroupingRuleProvider : FileStructureGroupRuleProvider {
    override fun getUsageGroupingRule(project: Project): UsageGroupingRule? = createGroupingRule<LmVariable>()
}

private inline fun <reified T : LmNamedElement> createGroupingRule(): UsageGroupingRule = object : SingleParentUsageGroupingRule() {
